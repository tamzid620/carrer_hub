...
import { faLocationArrow, faSackDollar, faBars , faPhone ,faEnvelope} from '@fortawesome/free-solid-svg-icons'
    ...
    return (
        <div className='flex pl-20 pr-20'>
            ...
            <div className='detail'>
                ...
                <hr />
                <p><span className='font-semibold'>  <FontAwesomeIcon icon={faSackDollar} /> Salary:</span> {salary}</p>
                <p><span className='font-semibold'> <FontAwesomeIcon icon={faBars} /> Job Title:</span> {jobTitle}</p>
                <h3 className='font-semibold'>Contact Information</h3>
                <hr />
                <p><span className='font-semibold'> <FontAwesomeIcon icon={faPhone} /> Phone:</span> {phone}</p>
                <p><span className='font-semibold'> <FontAwesomeIcon icon={faEnvelope} /> E-Mail:</span> {email}</p>
                <p><span className='font-semibold'> <FontAwesomeIcon icon={faLocationArrow} /> Address:</span> {location}</p>
                </div>
