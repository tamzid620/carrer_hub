...
const Jobs = ({job}) => {
    const { image, jobTitle , dutyType, dutyTime, companyName, location, salary } = job;
    const handleClick = () => {
    ...
    return (
        <div className='job p-4 text-left border mb-5 rounded-lg ml-auto mr-auto '>
            ...
            <button onClick={handleClick} className='rounded-lg bg-pink-500 text-white mt-3'>View Details</button>
        </div>
    );
};
export default Jobs;